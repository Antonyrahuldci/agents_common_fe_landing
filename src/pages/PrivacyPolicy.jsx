    ...
    <>
      <div className="container-fluid px-4 px-lg-0 terms overflow-hidden">
        ...
        <div className="container mt-5 px-lg-5  pt-5 p-0">
          <h1 className="privacy-policy-sim">Privacy Policy for Simbli</h1>
          ...
          <h6 className="privacy-policy-h4 pt-3">
            Interpretation and Definitions
          </h6>

          <h6 className="privacy-policy-h5 pt-4">Interpretation</h6>
          <p className="privacy-policy-p">
          ...
          <h6 className="privacy-policy-h5 pt-4">Definitions</h6>
          <p className="privacy-policy-p">
          ...
          <ul className="privacy-policy-p">
            ...
            <li className="pt-2">
              ...
              "We", "Us" or "Our" in this Agreement) refers to Dot Com Infoway,
              Plot No 3, Vaigai Colony I Floor.
            </li>
            ...
            <li className="pt-2">
              <strong>Website</strong> refers to Simbli, accessible from &nbsp;
              <a
                style={{ color: "#77D977" }}
                href="https://beta.simbli.ai/"
                target="_blank"
              >
                https://beta.simbli.ai/
              </a>
            </li>
          ...
          <h6 className="privacy-policy-h4 pt-4">
            Collecting and Using Your Personal Data
          </h6>

          <h6 className="privacy-policy-h5 pt-3">Types of Data Collected</h6>
          <h6 className="privacy-policy-h6 pt-3">Personal Data</h6>
          <p className="privacy-policy-p">
          ...
          <ul className="privacy-policy-p">
            <li className="pt-2">Email address</li>
            <li className="pt-2">First name and last name</li>
            <li className="pt-2">Usage Data</li>
          </ul>

          <h6 className="privacy-policy-h5 pt-3">Usage Data</h6>
          <p className="privacy-policy-p pt-3">
          ...
          {/* <!-- Tracking & Cookies --> */}
          <h6 className="privacy-policy-h5 pt-4">
          ...
          <p className="privacy-policy-p">
            ...
            web browser. You can learn more about cookies on the TermsFeed
            website article.
          </p>
          <p className="privacy-policy-p">
          ...
          <h6 className="privacy-policy-h5 pt-3">Types of Cookies We Use</h6>
          <ul className="privacy-policy-p">
            <li className="pt-2">
          ...
          {/* <!-- Use of Data --> */}
          <h6 className="privacy-policy-h5 pt-4">Use of Your Personal Data</h6>
          <p className="privacy-policy-p">
          ...
          {/* <!-- Delete --> */}
          <h6 className="privacy-policy pt-4">Delete Your Personal Data</h6>
          <p className="privacy-policy-p pt-3">
          ...
          <span className="privacy-policy-span pt-4">
            Business Transactions
          </span>
          <p className="privacy-policy-p pt-2">
            If the Company is involved in a merger, acquisition or asset sale...
          </p>

          <span className="privacy-policy-span pt-3">Law enforcement</span>
          <p className="privacy-policy-p pt-2">
          ...
          <span className="privacy-policy-span pt-3">
          ...
          <ul>
            <li className="li-compy pt-2">Comply with a legal obligation</li>
            <li className="li-compy pt-2">
            ...
            <li className="li-compy pt-2">Protect against legal liability</li>
          </ul>
          ...
          {/* <!-- Children's Privacy --> */}
          <h6 className="privacy-policy-h4 pt-4">Children's Privacy</h6>
          <p className="privacy-policy-p pt-4">
          ...
          {/* <!-- Links --> */}
          <h6 className="privacy-policy-h4 pt-4">Links to Other Websites</h6>
          <p className="privacy-policy-p pt-4">
          ...
          {/* <!-- Contact --> */}
          <h6 className="privacy-policy-h4 pt-4">Contact Us</h6>
          <p className="privacy-policy-p">
