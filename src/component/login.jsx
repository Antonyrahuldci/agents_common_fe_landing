    ...
    <>
      ...
      <Dialog
        ...
        PaperProps={{
          sx: {
            background:
              "linear-gradient(180deg, rgba(0, 0, 0, 0.356) 0%, rgba(55, 55, 55, 0.397) 100%)",
            border: "1px solid #5353537e",
            borderRadius: "12px",
            color: "#fff",
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <div
            style={{
              ...
              height: "70px",
              borderRadius: "50%",
              background: "linear-gradient(90deg, #7ddd7d, #54c754)",
              display: "flex",
          ...
          >
            <GppMaybeIcon sx={{ fontSize: 36, color: "#000" }} />
          </div>
        </div>
        ...
        <DialogContent sx={{ textAlign: "center", padding: "8px 16px" }}>
          ...
          >
            Your email is not authorized to log in. Please contact the admin for
            access or join the waitlist to get early access.
          </p>
        </DialogContent>
        ...
        <DialogActions sx={{ justifyContent: "center", marginTop: "20px" }}>
          <Button
            component="a"
            href="https://www.simbli.ai/"
            target="_blank"
            rel="noopener noreferrer"
            sx={{
              background: "linear-gradient(90deg, #54c754 0%, #7ddd7d 100%)",
              color: "#000",
              fontWeight: 700,
              borderRadius: "50px",
              textTransform: "none",
              padding: "12px 28px",
              fontSize: "16px",
              boxShadow: "0 4px 12px rgba(125, 221, 125, 0.4)",
              transition: "all 0.3s ease",
              "&:hover": {
                background: "linear-gradient(90deg, #65d765 0%, #8eed8e 100%)",
                boxShadow: "0 6px 18px rgba(125, 221, 125, 0.6)",
              },
            }}
          >
            Join Waitlist
